...
Digitale technologie is anno 2019 niet meer weg te denken \(zie het boek van Miriam Rasch 'Shadowbook, Writing Through the Digital 2014-2018'\). Een frontender ontwikkelt interfaces op het snijvlak van de fysieke en digitale wereld. Alle digitale producten worden gebruikt door mensen en moeten goed en betrouwbaar werken. Hier komt technologie bij kijken, maar ook design, en soft-skills. Bijna elke onderneming heeft een uiting op het web, veel grote ondernemingen hebben een interne web afdeling en er zijn legio voorbeelden van succesvolle ondernemingen die voor hun bedrijfsvoering volledig afhankelijk zijn van het web \(vb. Bol, Zalando\). 
...
De AD Frontend richt zich niet op: Full-stack development \(AD Software Engineering?\), Mobile/Tablet \(Native\) Frontend Development \(AD Software Engineering?\), Frontend SEO Expertise \(AD Content?\), Frontend Accessibility Expertise \(BA/MA\), Frontend Dev. Ops \(BA/MA\), Frontend Testing/QA \(BA/MA\). Wel kunnen sommige onderdelen van deze vakgebieden tijdens onze opleiding aan bod komen.
